...
class ObservarSolicitudCadete : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_observar_solicitud_cadete)
        ...
        val recyclerView: RecyclerView = findViewById(R.id.RecycleViewCadete)
    ...
    private fun onAcceptButtonClick(solicitud: ResultadoSolicitud) {
        ...
        nivelFuncion.CompletarSolicitud(solicitud,this)
